...
for file in manifest.json Service.qml BarWidget.qml Configuration.qml backend.py download.py book_download.py settings.py spotify.py music.py lookup.py games.py movies.py books.py; do
